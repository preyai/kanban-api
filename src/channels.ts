...
export const channels = (app: Application) => {
  ...
  app.service('boards').publish((data, context: HookContext) => {
    console.log(data.title);
    return [app.channel('authenticated')]
  })
  app.service('lists').publish((data, context: HookContext) => {
    console.log(data.title);
    return [app.channel('authenticated')]
  })
  app.service('tasks').publish((data, context: HookContext) => {
    console.log(data.title);
    return [app.channel('authenticated')]
  })
